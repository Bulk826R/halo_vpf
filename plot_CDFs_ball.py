...
h = 0.6774
baseDir = '/oak/stanford/orgs/kipac/users/ycwang19/VPF/SZ/haver'

x_up_1 = np.loadtxt(baseDir+'/CDF/x_up_1NN.txt')
y_up_1 = np.loadtxt(baseDir+'/CDF/y_up_1NN.txt')
X_up_1 = np.loadtxt(baseDir+'/CDF/X_up_1NN.txt')
Y_up_1 = np.loadtxt(baseDir+'/CDF/Y_up_1NN.txt')
S_up_1 = np.loadtxt(baseDir+'/CDF/S_up_1NN.txt')
x_down_1 = np.loadtxt(baseDir+'/CDF/x_down_1NN.txt')
y_down_1 = np.loadtxt(baseDir+'/CDF/y_down_1NN.txt')

x_up_2 = np.loadtxt(baseDir+'/CDF/x_up_2NN.txt')
y_up_2 = np.loadtxt(baseDir+'/CDF/y_up_2NN.txt')
X_up_2 = np.loadtxt(baseDir+'/CDF/X_up_2NN.txt')
Y_up_2 = np.loadtxt(baseDir+'/CDF/Y_up_2NN.txt')
S_up_2 = np.loadtxt(baseDir+'/CDF/S_up_2NN.txt')
x_down_2 = np.loadtxt(baseDir+'/CDF/x_down_2NN.txt')
y_down_2 = np.loadtxt(baseDir+'/CDF/y_down_2NN.txt')

x_up_4 = np.loadtxt(baseDir+'/CDF/x_up_4NN.txt')
y_up_4 = np.loadtxt(baseDir+'/CDF/y_up_4NN.txt')
X_up_4 = np.loadtxt(baseDir+'/CDF/X_up_4NN.txt')
Y_up_4 = np.loadtxt(baseDir+'/CDF/Y_up_4NN.txt')
S_up_4 = np.loadtxt(baseDir+'/CDF/S_up_4NN.txt')
x_down_4 = np.loadtxt(baseDir+'/CDF/x_down_4NN.txt')
y_down_4 = np.loadtxt(baseDir+'/CDF/y_down_4NN.txt')

x_up_8 = np.loadtxt(baseDir+'/CDF/x_up_8NN.txt')
y_up_8 = np.loadtxt(baseDir+'/CDF/y_up_8NN.txt')
X_up_8 = np.loadtxt(baseDir+'/CDF/X_up_8NN.txt')
Y_up_8 = np.loadtxt(baseDir+'/CDF/Y_up_8NN.txt')
S_up_8 = np.loadtxt(baseDir+'/CDF/S_up_8NN.txt')
x_down_8 = np.loadtxt(baseDir+'/CDF/x_down_8NN.txt')
y_down_8 = np.loadtxt(baseDir+'/CDF/y_down_8NN.txt')
...
ax1.set_ylabel(r'$\mathrm{CDF}$', fontsize = 24, labelpad = 8)
...
ax1.set_yticks(np.logspace(-3, 0, 4))
...
ax2.set_xlabel(r'$\theta\,$[$\mathrm{rad}$]', fontsize = 24, labelpad = 8)
ax2.set_ylabel(r'$\delta(\mathrm{CDF})/\sigma$', fontsize = 24, labelpad = 8)
...
'''
fig.savefig(baseDir+'/../../figures/CDFs_haver.png', dpi = 400, bbox_inches = 'tight')
plt.show()
