...
'''
Yd1 = CDF_1h(binc1) - CDF_2h(binc1)
Yd2 = CDF_2h(binc2) - CDF_3h(binc2)
Yd4 = CDF_4h(binc4) - CDF_5h(binc4)
Yd8 = CDF_8h(binc8) - CDF_9h(binc8)
#print('Yd = ', Yd)
...
Yp1 = [CDF_1g(binc1) - CDF_2g(binc1)]
Yp2 = [CDF_2g(binc2) - CDF_3g(binc2)]
Yp4 = [CDF_4g(binc4) - CDF_5g(binc4)]
Yp8 = [CDF_8g(binc8) - CDF_9g(binc8)]
print(Yp1)
print(Yp2)
print(Yp4)
print(Yp8)
...
x_up1 = binc1[id_fin1]
y_up1 = Yd1[id_fin1]
np.savetxt(baseDir+'/CIC/x_up_1NN.txt', x_up1)
np.savetxt(baseDir+'/CIC/y_up_1NN.txt', y_up1)
X_up1 = binc1[id_fin1]
Y_up1 = Mp1[id_fin1]
S_up1 = STD1[id_fin1]
np.savetxt(baseDir+'/CIC/X_up_1NN.txt', X_up1)
np.savetxt(baseDir+'/CIC/Y_up_1NN.txt', Y_up1)
np.savetxt(baseDir+'/CIC/S_up_1NN.txt', S_up1)
rD1 = np.abs(Yd1 - Mp1) / STD1
x_down1 = binc1[id_fin1]
y_down1 = rD1[id_fin1]
np.savetxt(baseDir+'/CIC/x_down_1NN.txt', x_down1)
np.savetxt(baseDir+'/CIC/y_down_1NN.txt', y_down1)

x_up2 = binc2[id_fin2]
y_up2 = Yd2[id_fin2]
np.savetxt(baseDir+'/CIC/x_up_2NN.txt', x_up2)
np.savetxt(baseDir+'/CIC/y_up_2NN.txt', y_up2)
X_up2 = binc2[id_fin2]
Y_up2 = Mp2[id_fin2]
S_up2 = STD2[id_fin2]
np.savetxt(baseDir+'/CIC/X_up_2NN.txt', X_up2)
np.savetxt(baseDir+'/CIC/Y_up_2NN.txt', Y_up2)
np.savetxt(baseDir+'/CIC/S_up_2NN.txt', S_up2)
rD2 = np.abs(Yd2 - Mp2) / STD2
x_down2 = binc2[id_fin2]
y_down2 = rD2[id_fin2]
np.savetxt(baseDir+'/CIC/x_down_2NN.txt', x_down2)
np.savetxt(baseDir+'/CIC/y_down_2NN.txt', y_down2)

x_up4 = binc4[id_fin4]
y_up4 = Yd4[id_fin4]
np.savetxt(baseDir+'/CIC/x_up_4NN.txt', x_up4)
np.savetxt(baseDir+'/CIC/y_up_4NN.txt', y_up4)
X_up4 = binc4[id_fin4]
Y_up4 = Mp4[id_fin4]
S_up4 = STD4[id_fin4]
np.savetxt(baseDir+'/CIC/X_up_4NN.txt', X_up4)
np.savetxt(baseDir+'/CIC/Y_up_4NN.txt', Y_up4)
np.savetxt(baseDir+'/CIC/S_up_4NN.txt', S_up4)
rD4 = np.abs(Yd4 - Mp4) / STD4
x_down4 = binc4[id_fin4]
y_down4 = rD4[id_fin4]
np.savetxt(baseDir+'/CIC/x_down_4NN.txt', x_down4)
np.savetxt(baseDir+'/CIC/y_down_4NN.txt', y_down4)

x_up8 = binc8[id_fin8]
y_up8 = Yd8[id_fin8]
np.savetxt(baseDir+'/CIC/x_up_8NN.txt', x_up8)
np.savetxt(baseDir+'/CIC/y_up_8NN.txt', y_up8)
X_up8 = binc8[id_fin8]
Y_up8 = Mp8[id_fin8]
S_up8 = STD8[id_fin8]
np.savetxt(baseDir+'/CIC/X_up_8NN.txt', X_up8)
np.savetxt(baseDir+'/CIC/Y_up_8NN.txt', Y_up8)
np.savetxt(baseDir+'/CIC/S_up_8NN.txt', S_up8)
rD8 = np.abs(Yd8 - Mp8) / STD8
x_down8 = binc8[id_fin8]
y_down8 = rD8[id_fin8]
np.savetxt(baseDir+'/CIC/x_down_8NN.txt', x_down8)
np.savetxt(baseDir+'/CIC/y_down_8NN.txt', y_down8)
