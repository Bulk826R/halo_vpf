...
for i in range(Nhalos):
    fname = '/oak/stanford/orgs/kipac/users/ycwang19/VPF/SZ/knn_qui/rand_'+str(i)+'.txt'
...
np.savetxt('/oak/stanford/orgs/kipac/users/ycwang19/VPF/SZ/knn_qui/knn_rand.txt', res)